...
//        NSLog(@"妈的 狗逼objc got response!---- %@", responseData);
//    }];
...
- (void)renderButtons:(UIWebView*)webView {
    ...
    UIButton* bottmonButton = [UIButton buttonWithType:UIButtonTypeRoundedRect];
    [bottmonButton setTitle:@"ToNextPage" forState:UIControlStateNormal];
    [bottmonButton addTarget:self action:@selector(toNextPage) forControlEvents:UIControlEventTouchUpInside];
    [self.view insertSubview:bottmonButton aboveSubview:webView];
    bottmonButton.frame = CGRectMake(210, 414+80, 100, 35);
    bottmonButton.titleLabel.font = font;
}
